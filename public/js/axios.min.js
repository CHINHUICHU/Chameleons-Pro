!(function (e, t) {
    ...
    return new Promise(function (t, r) {
      ...
      void 0 === o && i.setContentType(null),
        ...
        (e.cancelToken || e.signal) &&
          ((n = function (t) {
            u &&
              (r(!t || t.type ? new oe(null, e, u) : t), u.abort(), (u = null));
          }),
  ...
  je.transitional = function (e, t, r) {
    function n(e, t) {
      return (
        "[Axios v1.1.0] Transitional option '" +
        e +
        "'" +
        t +
        (r ? '. ' + r : '')
        ...
        o(e, [
          {
            ...
            value: function (e, t) {
              ...
              var n =
                t.headers && _.merge(t.headers.common, t.headers[t.method]);
              n &&
                _.forEach(
  ...
  _.forEach(['delete', 'get', 'head', 'options'], function (e) {
    Ne.prototype[e] = function (t, r) {
      return this.request(
        Se(r || {}, { method: e, url: t, data: (r || {}).data })
      );
    };
  }),
    _.forEach(['post', 'put', 'patch'], function (e) {
